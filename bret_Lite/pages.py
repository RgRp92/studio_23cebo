...
class Results(Page):
    ...
    def before_next_page(self):
        self.participant.vars['box_value'] = Constants.box_value
        self.participant.vars['boxes_total'] = Constants.num_rows * Constants.num_cols
        self.participant.vars['boxes_collected'] = self.player.boxes_collected
        self.participant.vars['bomb'] = self.player.bomb
        self.participant.vars['bomb_row'] = self.player.bomb_row
        self.participant.vars['bomb_col'] = self.player.bomb_col
        self.participant.vars['round_result'] = self.player.round_result
        self.participant.vars['round_to_pay'] = self.participant.vars['round_to_pay']
        self.participant.vars['payoff'] = self.player.payoff
        self.participant.vars['total_payoff'] = self.participant.vars['bret_payoff']


# ******************************************************************************************************************** #
# *** PAGE SEQUENCE *** #
# ******************************************************************************************************************** #
page_sequence = [Page_Init, Page0, Decision, Results]
